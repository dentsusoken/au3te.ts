...
export default class PushedAuthReqHandler extends BaseHandler {
    ...
    //     public setparameters(): { [key: string]: string } | undefined {
    //         return this.parameters;
    //     }
    //     public setAuthorization(): string | undefined {
    //         return this.authorization;
    //     }
    //     public setclientCertificatePath(): string[] | undefined {
    //         return this.clientCertificatePath;
    //     }
    //     public setdpop(): string | undefined {
    //         return this.dpop;
    //     }
    //     public sethtm(): string | undefined {
    //         return this.htm;
    //     }
    // }
